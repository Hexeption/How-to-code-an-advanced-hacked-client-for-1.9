...
public abstract class RenderLivingBase<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected boolean field_188323_j = false;
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        try
        {
            ...
            if (!entity.isRiding())
            {
                f5 = entity.field_184618_aE + (entity.limbSwingAmount - entity.field_184618_aE) * partialTicks;
                f6 = entity.field_184619_aG - entity.limbSwingAmount * (1.0F - partialTicks);
    ...
    {
        boolean flag = !entitylivingbaseIn.isInvisible() || this.field_188301_f;
    ...
    public void renderName(T entity, double x, double y, double z)
    {
        if (this.canRenderName(entity))
        {
            ...
            if (d0 < (double)(f * f))
            {
                ...
                this.func_188296_a(entity, x, y, z, s, d0);
            }
        }
    }
