...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private final DataFixer dataFixer = DataFixesManager.func_188279_a();
    ...
    public Minecraft(GameConfiguration gameConfig)
    {
        ...
        this.field_184130_ao = gameConfig.gameInfo.versionType;
        this.twitchDetails = gameConfig.userInfo.userProperties;
        this.profileProperties = gameConfig.userInfo.profileProperties;
        this.mcDefaultResourcePack = new DefaultResourcePack(gameConfig.folderInfo.func_187052_a());
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        AchievementList.field_187982_f.setStatStringFormatter(new IStatStringFormat()
        {
    ...
    public void refreshResources()
    {
        ...
        {
            this.theIntegratedServer.func_184116_b();
        }
    ...
    private void sendClickBlockToController(boolean leftClick)
    {
        ...
        if (this.leftClickCounter <= 0 && !this.thePlayer.func_184587_cr())
        {
    ...
    private void clickMouse()
    {
        if (this.leftClickCounter <= 0)
        {
            ...
            else if (!this.thePlayer.func_184838_M())
            {
    ...
    private void rightClickMouse()
    {
        if (!this.playerController.getIsHittingBlock())
        {
            ...
            if (!this.thePlayer.func_184838_M())
            {
                        ...
                        switch (this.objectMouseOver.typeOfHit)
                        {
                            ...
                            case BLOCK:
                                ...
                                if (this.theWorld.getBlockState(blockpos).getMaterial() != Material.air)
                                {
                                    ...
                                    EnumActionResult enumactionresult = this.playerController.func_187099_a(this.thePlayer, this.theWorld, itemstack, blockpos, this.objectMouseOver.sideHit, this.objectMouseOver.hitVec, enumhand);
    ...
    private boolean func_184122_c(int p_184122_1_)
    {
        ...
        else if (p_184122_1_ == 48)
        {
            ...
            this.func_184120_a("Hitboxes: {0}", new Object[] {flag ? "shown" : "hidden"});
            return true;
        }
        ...
        else if (p_184122_1_ == 33)
        {
            ...
            this.func_184120_a("RenderDistance: {0}", new Object[] {Integer.valueOf(this.gameSettings.renderDistanceChunks)});
            return true;
        }
        else if (p_184122_1_ == 35)
        {
            this.gameSettings.advancedItemTooltips = !this.gameSettings.advancedItemTooltips;
            this.func_184120_a("Advanced tooltips: {0}", new Object[] {this.gameSettings.advancedItemTooltips ? "shown" : "hidden"});
            this.gameSettings.saveOptions();
            return true;
        }
        ...
        else if (p_184122_1_ == 25)
        {
            ...
            this.gameSettings.saveOptions();
            this.func_184120_a("PauseOnLostFocus: {0}", new Object[] {this.gameSettings.pauseOnLostFocus ? "enabled" : "disabled"});
            return true;
        }
    ...
    private void func_184117_aA()
    {
        ...
        while (this.gameSettings.field_186718_X.isPressed())
        {
            if (!this.thePlayer.isSpectator())
            {
        ...
        if (this.thePlayer.func_184587_cr())
        {
        ...
        if (this.gameSettings.keyBindUseItem.isKeyDown() && this.rightClickDelayTimer == 0 && !this.thePlayer.func_184587_cr())
        {
            this.rightClickMouse();
        }
    ...
    private ItemStack func_184119_a(ItemStack p_184119_1_, TileEntity p_184119_2_)
    {
        ...
        p_184119_2_.writeToNBT(nbttagcompound);

        if (p_184119_1_.getItem() == Items.skull && nbttagcompound.hasKey("Owner"))
        {
            NBTTagCompound nbttagcompound2 = nbttagcompound.getCompoundTag("Owner");
            NBTTagCompound nbttagcompound3 = new NBTTagCompound();
            nbttagcompound3.setTag("SkullOwner", nbttagcompound2);
            p_184119_1_.setTagCompound(nbttagcompound3);
            return p_184119_1_;
        }
        else
        {
    ...
    public void addServerStatsToSnooper(Snooper playerSnooper)
    {
        ...
        playerSnooper.addClientStat("subtitles", Boolean.valueOf(this.gameSettings.field_186717_N));
